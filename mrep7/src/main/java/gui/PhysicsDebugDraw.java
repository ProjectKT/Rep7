...
/**
 * TestBed のソースコード
 * https://code.google.com/p/jbox2d/source/browse/trunk/jbox2d-testbed/src/main/java/org/jbox2d/testbed/framework/j2d/DebugDrawJ2D.java
 * を参照.
 * 
 * テスト用にほとんど同じ内容になっているので後で自前で作る予定。
 */
